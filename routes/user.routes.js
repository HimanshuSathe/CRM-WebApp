...
module.exports = function (app) {
    ...
    app.patch("/crmapp/api/v1/user/updateUserStatus", authValidators.isUserAuthenticated, authValidators.isAdmin, userController.updateUserType); //update 
